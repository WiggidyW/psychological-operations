...
pub struct Request {
    pub query: UserSearchQueryVnext,
    ...
    pub expansions: Option<Vec<crate::x::params::user_expansions_parameter::UserExpansions>>,
...
pub type Response = Get2UsersSearchResponse;
