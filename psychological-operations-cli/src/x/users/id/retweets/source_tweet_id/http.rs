...
//! HTTP call helpers for /2/users/{id}/retweets/{source_tweet_id}.
...
pub async fn delete(
    ...
    let path = format!("users/{}/retweets/{}", urlencoding::encode(&req.id.to_string()), urlencoding::encode(&req.source_tweet_id.to_string()));
