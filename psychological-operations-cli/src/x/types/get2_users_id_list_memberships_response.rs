...
pub struct Get2UsersIdListMembershipsResponse {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<List>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<Problem>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub includes: Option<Expansions>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub meta: Option<Get2UsersIdListMembershipsResponseMeta>,
}


#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Get2UsersIdListMembershipsResponseMeta {
    #[serde(skip_serializing_if = "Option::is_none")]
