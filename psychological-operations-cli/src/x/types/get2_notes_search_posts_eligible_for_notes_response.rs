...
pub struct Get2NotesSearchPostsEligibleForNotesResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub meta: Option<Get2NotesSearchPostsEligibleForNotesResponseMeta>,
}


#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Get2NotesSearchPostsEligibleForNotesResponseMeta {
    #[serde(skip_serializing_if = "Option::is_none")]
