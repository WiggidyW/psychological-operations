...
pub struct Get2DmConversationsIdDmEventsResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub meta: Option<Get2DmConversationsIdDmEventsResponseMeta>,
}


#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Get2DmConversationsIdDmEventsResponseMeta {
    #[serde(skip_serializing_if = "Option::is_none")]
