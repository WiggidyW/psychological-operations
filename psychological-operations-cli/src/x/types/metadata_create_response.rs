...
pub struct MetadataCreateResponse {
    ...
    pub data: Option<MetadataCreateResponseData>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct MetadataCreateResponseData {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub associated_metadata: Option<MetadataCreateResponseDataAssociatedMetadata>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<MediaId>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MetadataCreateResponseDataAssociatedMetadata {
    #[serde(skip_serializing_if = "Option::is_none")]
