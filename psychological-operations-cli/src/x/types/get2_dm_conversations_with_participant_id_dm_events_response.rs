...
pub struct Get2DmConversationsWithParticipantIdDmEventsResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub meta: Option<Get2DmConversationsWithParticipantIdDmEventsResponseMeta>,
}


#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Get2DmConversationsWithParticipantIdDmEventsResponseMeta {
    #[serde(skip_serializing_if = "Option::is_none")]
