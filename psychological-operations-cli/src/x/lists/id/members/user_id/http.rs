...
//! HTTP call helpers for /2/lists/{id}/members/{user_id}.
...
pub async fn delete(
    ...
    let path = format!("lists/{}/members/{}", urlencoding::encode(&req.id.to_string()), urlencoding::encode(&req.user_id.to_string()));
